...
@TaroStruct
public class getWordListReq extends TarsusBodyABS {
    public String desc;
    ...
    // ListConstructor
    public getWordListReq(List<?> list) {
        TarsusStream _tarsusStream = new TarsusStream(list, "getWordListReq");
